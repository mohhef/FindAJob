...
insert into orders (order_id, order_date) values ('o11', '2019-06-10');
...
insert into `book_order` (order_id,ISBN,qty,arrival_date) values ('o11', '321821287-1', 123, '2019-03-04');
