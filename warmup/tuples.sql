...
insert into `order_from` (branch_name,publisher_number,order_id) values ('b7', 'p7', 'o7');
insert into `order_from` (branch_name,publisher_number,order_id) values ('b8', 'p8', 'o8');
insert into `order_from` (branch_name,publisher_number,order_id) values ('b9', 'p9', 'o9');
insert into `order_from` (branch_name,publisher_number,order_id) values ('b10', 'p10', 'o10');
...
/*interested_in*/
insert into interested_in (cid, category_name) values ("c1", "fantasy");
