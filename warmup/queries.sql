...
select bo.order_id, o.order_date, bo.isbn,bo.qty,off.branch_name
from orders o, order_from off, book_order bo
where o.order_id =  bo.order_id and bo.order_id = off.order_id and bo.arrival_date is null and publisher_number = "p1";
...
select c.cid, c.first_name, st.transaction_id, st.quantity, st.order_date, b.title, b.isbn, b.selling_price, b.book_subject
...
select bo.isbn as book_sold, sum(bo.qty) as quantity_sold, sum(bo.cost_price*bo.qty) as total_sales
...
select b.title, b.isbn, b.selling_price, b.book_subject, s.quantity_on_hand, a.author_name
