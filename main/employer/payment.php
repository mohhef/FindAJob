...
<nav id="nav" class="navbar navbar-expand-sm  navbar-dark"></nav>
...
$(document).ready(function() {
    ...
    //     $('#chequingAddModal').modal('show');
    // });

    // $("#chequingAddModal").on('submit','#chequingAddForm', function(event){
    //     event.preventDefault();
    //     $('#save').attr('disabled','disabled');
    //     var formData = $(this).serialize();
    //     var account_no = jQuery('input[name="accountAddNo"]').val();
    //     var bank_no = jQuery('input[name="bankAddNo"]').val();
    //     var transit_no = jQuery('input[name="transitAddNo"]').val();
    ...
    $("#chequingUpdateModal").on('click', '.submit_create', function(event) {
        ...
        var bankNo = jQuery('input[name="bankNo"]').val();
        var transitNo = jQuery('input[name="transitNo"]').val();
        console.log(accountNo, bankNo, transitNo);
        $.post("../database/create_chequing.php", {
            post_chequing: true,
            account_no: accountNo,
            bank_no: bankNo,
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    $('#alert_message').html(
                                        ...
                                        data + '</div>');
                                    //  $('#chequing_data').DataTable().destroy();
                                    //fetch_data();
